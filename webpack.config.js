...
module.exports = {
  ...
  module: { // 配置所有第三方loader 模块的
    rules: [ // 第三方模块的匹配规则
      ...
      { test: /\.(jpg|png|gif|bmp|jpeg)$/, use: 'file-loader?limit=5000' }, // 处理 图片路径的 loader?limit=7631&name=[hash:8]-[name].[ext]
      // limit 给定的值，是图片的大小，单位是 byte， 如果我们引用的 图片，大于或等于给定的 limit值，则不会被转为base64格式的字符串， 如果 图片小于给定的 limit 值，则会被转为 base64的字符串
      { test: /\.(ttf|eot|svg|woff|woff2)$/, use: 'file-loader' }, // 处理 字体文件的 loader 
